...
class MainActivity : AppCompatActivity(), TaskAdapter.OnTaskClickListener, PinnedTaskAdapter.OnTaskClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        upcomingTasks = arrayOf(
            Task("School", "Research Paper", "Draft the introduction and literature review for the research paper", "Not Started", "July 27, 2024", "July 5, 2024"),
            Task("Work", "Team Meeting", "Discuss project milestones and deliverables with the team", "In Progress", "July 28, 2024", "July 3, 2024"),
            Task("Personal", "Doctor's Appointment", "Annual physical check-up with Dr. Smith", "Complete", "July 29, 2024", "July 8, 2024"),
            Task("Fitness", "Morning Run", "Complete a 5km run in the park", "Not Started", "July 30, 2024", "July 15, 2024")
        )
